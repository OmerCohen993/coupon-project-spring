package com.coupon.couponprojectspring.utils;
...
//	prints only classes like beans with get methods
//	used example:
//  Table.print(myClass);
//  Table.print(myCollection<MyClass>);

/**
 * Credit: Ido Zahavy - https://github.com/idozahavy
 */
public class TablePrinter {


    // can add here field names you don't want to show,
