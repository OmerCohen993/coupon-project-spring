...
import com.coupon.couponprojectspring.services.serviceDAO.CustomerService;
...
public class CustomerServiceImpl extends ClientService implements CustomerService {
     ...
     * @throws NotExistException If the customer was not found
     */
    @Override
    public Customer getCustomerDetails() throws NotExistException {
        return customerRepo.findById(this.customerID).orElseThrow(() -> new NotExistException(ExceptionType.CUSTOMER));
    }
